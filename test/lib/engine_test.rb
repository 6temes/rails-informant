...
class RailsInformant::EngineTest < ActiveSupport::TestCase
  test "validate_api_token! raises when api_token is nil and capture_errors is enabled" do
  ...
  test "validate_api_token! raises when api_token is shorter than 32 characters" do
    RailsInformant.config.capture_errors = true
